...
void Turret::shoot(std::vector<Bullet>* bullets, sf::Sprite* sprite, LevelVector* level, sf::Vector2u levelSize, sf::Sprite* explosion, Player* player)
{
	bullets->push_back(Bullet(sprite, level, levelSize, explosion, player, bulletSpawn, bulletVelocity));
}
